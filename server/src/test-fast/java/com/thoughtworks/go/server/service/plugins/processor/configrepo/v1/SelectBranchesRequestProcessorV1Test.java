...
public class SelectBranchesRequestProcessorV1Test {
    ...
    void processRespondsWithListOfBranchContexts() {
        ...
        when(materialService.refsMatching(any(ScmMaterial.class), any(Pattern.class))).thenReturn(asList("refs/heads/foo", "refs/heads/fuu"));
        ...
        final List<Map<String, Object>> result = gson.fromJson(response.responseBody(), new TypeToken<List<Map<String, Object>>>() {}.getType());
