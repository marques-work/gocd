...
public class SelectBranchesRequest1_0 implements SelectBranchesRequest, MessageHandlerForSelectBranchesRequestProcessor {
    ...
    /**
     * Right now, we are only supporting Git. Not to say we could not support other SCMs, but let's see
     * what the demands are, and also the technical limitations.
     *
     * @return an {@link ScmMaterial} representing a matched ref/branch on the base SCM repo
     */
    @Override
