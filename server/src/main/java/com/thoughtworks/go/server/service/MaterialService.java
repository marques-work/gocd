...
public class MaterialService {
    ...
    public List<String> refsMatching(ScmMaterial material, Pattern pattern) {
        return material.remoteRefs().stream().filter(pattern.asMatchPredicate()).collect(Collectors.toList());
    }
